package com.ejo.glowhud.gui.element.elements.window;

import com.ejo.glowhud.GlowHUD;
import com.ejo.glowhud.gui.element.GuiWidget;
import com.ejo.glowhud.gui.element.elements.window.windows.SettingWindow;
import com.ejo.glowhud.util.Key;
...
public abstract class GuiWindow extends GuiWidget {
    ...
    public GuiWindow(Screen screen, String title, Vector pos, Vector size) {
        ...
        SettingManager manager = this instanceof SettingWindow ? SettingManager.getDefaultManager() : GlowHUD.getSettingManager();
    ...
    public void drawWidget(PoseStack stack, Vector mousePos) {
        if (Minecraft.getInstance().screen == GlowHUD.getGuiManager().getGui()) {
        ...
        if (Minecraft.getInstance().screen == GlowHUD.getGuiManager().getGui() && shouldDrawPin()) {
            if (isPinned()) {
