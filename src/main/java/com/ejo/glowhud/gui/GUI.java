...
import com.ejo.glowhud.gui.element.elements.*;
import com.ejo.glowhud.gui.element.GuiWidget;
import com.ejo.glowhud.gui.element.elements.window.windows.*;
...
public class GUI extends Screen {
    ...
    private final GuiButton saveButton = new GuiButton(this,"Save",new Vector(width-30,height-20),new Vector(30,20),new ColorE(0,100,175,200),(params) -> {
        GlowHUD.getSettingManager().saveAll();
        Util.sendMessage("GlowHUD: Settings Saved");
    });
